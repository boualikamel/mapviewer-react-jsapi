...
/**
 * this file is used to generate the base maps 
 * there is a default base map
 * and many other declarations
 * **/ 
...
const baseMaps = [
  ...
  new Basemap({
    baseLayers: [
      new WebTileLayer({
        urlTemplate: 'http://{subDomain}.google.com/vt/lyrs=s&x={col}&y={row}&z={level}',
        subDomains: ['mt0', 'mt1', 'mt2', 'mt3'],
      }),
    ],
